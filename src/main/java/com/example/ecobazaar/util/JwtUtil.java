package com.example.ecobazaar.util;
...
public class JwtUtil {
    ...
    public Claims getClaims(String token) {
        return Jwts.parserBuilder()              // ✅ use parserBuilder()
                .setSigningKey(key)              // ✅ set the key here
                .setAllowedClockSkewSeconds(60)  // ✅ tolerate minor clock skew
                .build()
                .parseClaimsJws(token)           // ✅ parse signed JWT
                .getBody();                      // ✅ get Claims directly
    }
